package org.application.Function007;

import org.application.Function007.Diagnostic.addDiagnostic;
import org.application.Function007.RemovePatient.removePatient ;
import org.application.Function007.ListePatients.ListePatients ;
import org.application.Function007.AddPatient.addPatient;
import org.application.Function007.ModifiyPatient.modifiyPatient;
...
public class Menu {
    ...
    public static void AfficherMenu() throws SQLException {
        ...
        switch (choice) {
            case 1:
                // Ajouter un patient
                addPatient.ajouterPatient(); ;
                break;
            case 2:
                // Modifier les informations d'un patient
                modifiyPatient.modifiyrPatient();
                break;
            case 3:
